...
/*
  ...
  detail: PropTypes.string,   Default is blank, this is an optional message that appears under the main message.
      ...
      return this.state.isFlagVisible ? (
        !this.state.fadedIn ? (
          ...
          >
            <FlexRow>
              <FlexCol>
                <FlagTitle>{this.props.message}</FlagTitle>
                <FlagDetailText>{this.props.detail}</FlagDetailText>
              </FlexCol>
...
const FlagContainer = styled.div`
  ...
  border-radius: 6px;
  background: ${props =>
    props.borderColor ? props.borderColor : `rgb(255,255,255)`};
  overflow: hidden;
...
`
const FlagDetailText = styled.span`
